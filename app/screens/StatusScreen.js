    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.atas}>
                <Text style={{fontSize:24,color:"#003366",fontWeight:'bold',marginBottom:'10%'}}>HALAMAN STATUS</Text>
                <Ionicons name="ios-stats" size={100} color="black" />
            ...
            <View style={styles.portofolio}>
                ...
                <View style={styles.port}>
                    <View style={styles.unit}>
                        <Text style={{fontStyle:'italic'}}>Nama Lengkap</Text>
                        <Text style={{fontStyle:'italic'}}>Status</Text>
                        <Text style={{fontStyle:'italic'}}>Tanggal Pengecekan</Text>
                        <Text style={{fontStyle:'italic'}}>Tempat Pengecekan</Text>
                    </View>
                    <View style={styles.unit}>
                        <Text>:</Text>
                        <Text>:</Text>
                    ...
                    <View style={styles.unit}>
                        ...
                        <Text>- Status Pengguna -</Text>
                        <Text>- Tanggal Pengecekan -</Text>
                        <Text>- Tempat Pengecekan -</Text>
                    </View>
                </View>
            </View>
