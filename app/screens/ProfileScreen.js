        ...
        <View style={styles.container}>
            ...
            <View style={styles.atas}>
                <View
                    ...
                    />
                <Text style={{fontSize:24,color:"#003366",fontWeight:'bold',marginBottom:'10%'}}>PROFIL PENGGUNA</Text>
                <View
                    style={{
                        borderBottomColor: 'black',
                        borderBottomWidth: 1,
                ...
                <Text style={styles.login}>- Nama Pengguna -</Text>
                <Text style={styles.title}>User</Text>
            </View>
            <View style={styles.portofolio}>
                <Text style={{fontWeight:'bold'}}>Data Pribadi</Text>
                <View
                    style={{
                        borderBottomColor: 'black',
                        borderBottomWidth: 1,
                ...
                <View style={styles.port}>
                    <View style={styles.unit}>
                        ...
                        <Text style={{fontStyle:'italic'}}>Jenis Kelamin</Text>
